...
| **Виключні ситуації** | `UnfilledRegistrationRows`, `IncorrectUserName`, `IncorrectUserEmail`, `IncorrectPassword` |
...
| **Виключні ситуації** | `UnfilledLoginRows`, `NotFoundUserName`, `NotFoundUserEmail`, `IncorrectPassword` |
...
| **Виключні ситуації** | `NoChangedDate`, `EmptyDate`                         |
...
| **Виключні ситуації** | `IncorrectFileFormat`, `MissingData`                 |
...
| **Виключні ситуації** | `InsufficientDataForVisualization`, `InvalidVisualizationType`, `DataProcessingError` |
...
| **Результат**       | Успішна авторизація                                                  |
| **Виключні ситуації** | `UnfilledLoginRows`, `NotFoundAdminName`, `NotFoundAdminEmail`, `IncorrectPassword` |
...
| **Виключні ситуації** | `DataNotFound`                                                     |
...
| **Виключні ситуації** | `DataNotFinded`                                                    |
...
| **Виключні ситуації** | `UserNotFound`                                                     |
